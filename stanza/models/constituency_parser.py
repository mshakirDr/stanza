...
def parse_args(args=None):
    ...
    parser.add_argument('--train_beam_size', type=int, default=0, help='Train using a beam.  Adds a loss which builds up the gold state prediction if it falls off the beam')
